...
if [ ! -z "$sites" ] ; then
    ...
    echo "$sites"  | mutt -s "North Pines Sites Are Available!!! $DATE AWS" sungp2k@gmail.com 
else
    echo "No Sites Available"  | mutt -s "No North Pines Sites Are Available $DATE AWS" sungp2k@gmail.com 
