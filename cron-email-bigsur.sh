...
if [ ! -z "$sites" ] ; then
    ...
    echo "$sites"  | Mail -s "Big Sur Sites Are Available!!! $DATE" -c yeojinchun@gmail.com sungp2k@gmail.com 
else
    #echo "No Sites Available"  | Mail -s "No Sites Are Available $DATE" -c yeojinchun@gmail.com sungp2k@gmail.com 
