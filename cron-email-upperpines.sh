...
if [ ! -z "$sites" ] ; then
    ...
    echo "$sites"  | Mail -s "Upper Pines Sites Are Available!!! $DATE" -c spark0820@yahoo.com sungp2k@gmail.com 
else
    echo "No Sites Available"  | Mail -s "No Upper Pines Sites Are Available $DATE" -c spark0820@yahoo.com sungp2k@gmail.com 
